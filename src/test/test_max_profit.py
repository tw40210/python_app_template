...
class TestMaxProfit:
    class FakeArgs:
        def __init__(self):
            self.input = "test_data/max_profit/test.txt"
            self.output = "test_data/max_profit/testOutput.txt"
    ...
    def test_kernel(self):
        ...
        args = self.FakeArgs()
        with open("test_data/max_profit/kernel/data_np.pkl", "rb") as file:
            data_np = pickle.load(file)
            val, steps = profit_calculator.get_max_profit_steps(data_np, args.start, args.end)

        with open("test_data/max_profit/kernel/max_profit_val.pkl", "rb") as file:
            golden_val = pickle.load(file)

        with open("test_data/max_profit/kernel/steps.pkl", "rb") as file:
    ...
    def test_end_to_end(self):
        ...
        with open("test_data/max_profit/testOutput.txt", "r") as file:
            output_str = file.read()
        with open("test_data/max_profit/golden_output.txt", "r") as file:
